...
function Footer() {
  return (
    <footer className='w-full h-auto bg-[#0553B0] flex flex-col py-10 px-5 gap-7 lg:px-10'>
      <div className='w-full h-auto flex flex-col gap-8 sm:flex-row'>
        ...
        <div className='w-full h-auto sm:w-[60%] lg:w-[70%] lg:pb-8'>
          <p className='text-white font-semibold text-xl sm:text-2xl lg:text-4xl xl:text-5xl xl:leading-14 2xl:text-6xl 2xl:leading-20'>Your partner in enterprise software development, delivering scalable AI and data solutions that drive lasting business impact.</p>
        </div>
      </div>
      <div className='w-full h-auto flex flex-col gap-8 sm:flex-row'>
        <div className='w-full h-auto flex flex-col text-white font-semibold justify-center items-center sm:w-[30%] lg:w-[20%] sm:justify-start md:text-xl'>
          <span>Offices:</span>
      ...
      <div className='w-full h-auto flex flex-col gap-8 sm:flex-row'>
        ...
        <div className='w-full h-auto flex flex-wrap justify-center gap-6 items-center sm:w-[60%] lg:justify-start lg:gap-10 lg:w-[70%] lg:text-xl'>
